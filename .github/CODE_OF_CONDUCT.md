...
Instâncias abusivas, assedio, ou outros comportamentos inaceitáveis podem ser 
reportados contatando a equipe de projeto pelo endereço chatbotbinounb@gmail.com. 
Todas as reclamações serão revisadas e investigadas e irão resultar em uma resposta
considerada necessária e apropriada sob as circunstâncias. 
O time de projeto é obrigado a manter confidencialidade considerado pelo relatório do incidente. 
Mais detalhes sobre as políticas específicas da aplicação podem ser postadas separadamente.

Os mantenedores do projeto que não seguirem ou imporem o Código de Conduta em boa fé
devem enfrentar temporariamente ou permanentemente repercussões 
determinadas pelos outros membros da liderança do projeto.
